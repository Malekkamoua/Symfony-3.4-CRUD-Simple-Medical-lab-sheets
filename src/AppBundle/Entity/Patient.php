...
class Patient
{
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="ordenance", type="datetime",nullable=true)
     */
    private $ordenance;
     ...
     * @var string
     *
     * @ORM\Column(name="nomPrenomMed", type="string", length=255,nullable=true,nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="telMed", type="integer",nullable=true,nullable=true)
     */
    private $telMed;
     ...
     * @var string
     *
     * @ORM\Column(name="type_tube", type="string", length=255,nullable=true)
     */
    private $type_tube;
    ...
    private $nb_tube;
     ...
     /**
     *
     * @ORM\Column(name="type_dossier", type="string",nullable=true)
     */
